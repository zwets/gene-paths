...
"  on the target region on SEG, and + or - the strand.\n"
"\n"
"  When END is omitted, BEG specifies a zero-length position.  When BEG\n"
"  and END are omitted, the reference is the start of FROM or end of TO.\n"
"\n"
"  OPTIONS\n"
...
"  - We call the sequence data in GFA the + strand, the - strand is its.\n"
