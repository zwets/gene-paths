...
TEST(gfa2logic_test, contained_vtx) {
    ...
    ASSERT_EQ(v.left_overhang(), 0);
    ASSERT_EQ(v.right_overhang(), 0);
}
...
TEST(gfa2logic_test, left_blunt) {
    ...
    ASSERT_EQ(v.overlap(), 0);
    ASSERT_EQ(v.left_overhang(), 0);
    ASSERT_EQ(v.right_overhang(), v.l);
}
